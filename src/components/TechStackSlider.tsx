  ...
  return (
    <section className={`py-12 relative overflow-hidden ${className}`} id="tech-stack">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className={`${portfolioConfig.styling.glassBlur.techstackslider} p-8 md:p-12`}>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-transparent via-white/5 to-transparent p-6">
            ...
            >
              {infiniteTechnologies.map((tech, index) => (
                ...
                >
                  <div className={`flex flex-col items-center space-y-4 p-6 rounded-xl ${portfolioConfig.styling.glassBlur.cards} transition-all duration-300 hover:scale-105 hover:shadow-lg min-w-[120px]`}>
