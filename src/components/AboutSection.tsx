          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="group inline-flex items-center space-x-2 mt-6 px-6 py-3 bg-gradient-to-r from-orange-400 to-yellow-500 text-white rounded-full hover:from-orange-500 hover:to-yellow-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg shadow-orange-200/50"
              >
